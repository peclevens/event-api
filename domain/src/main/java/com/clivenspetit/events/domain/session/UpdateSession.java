 ...
 */
public final class UpdateSession implements Serializable {
    ...
    private UpdateSession(UpdateSession.Builder builder) {
    ...
    public static UpdateSession.Builder builder() {
        return new UpdateSession.Builder();
    }
