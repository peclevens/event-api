 ...
 */
public class UpdateSessionMother {

    public static UpdateSession.Builder validSession() {
        return UpdateSession.builder()
                .version(1)
    ...
    public static UpdateSession.Builder invalidSession() {
        return UpdateSession.builder()
                .version(-1)
                .name("A")
