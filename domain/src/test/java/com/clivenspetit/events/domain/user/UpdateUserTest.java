...
public class UpdateUserTest {
    ...
    private Set<ConstraintViolation<UpdateUser>> violations;
    ...
    public void validUserPassed_returnTrue() {
        UpdateUser user = UpdateUserMother.validUser().build();
    ...
    public void invalidUserPassed_returnFalse() {
        UpdateUser user = UpdateUserMother.invalidUser().build();
